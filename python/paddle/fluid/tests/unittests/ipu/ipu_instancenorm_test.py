...
class TestInstanceNormNet(unittest.TestCase):
    def _test(self, run_ipu=True):
        ...
        with paddle.static.program_guard(main_prog, startup_prog):
            ...
            instance = paddle.static.nn.instance_norm(
                input=conv1, param_attr=scale_attr, bias_attr=bias_attr)

            loss = paddle.mean(instance)
