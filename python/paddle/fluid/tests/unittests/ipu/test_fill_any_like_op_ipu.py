...
class TestBase(IPUOpTest):
    ...
    def set_attrs(self):
        self.attrs_fp32 = {'fill_value': 0.3, 'dtype': 'float32'}
        self.attrs_fp16 = {'fill_value': 0.3, 'dtype': 'float32'}
    ...
    def _test_base(self, run_mode=0):
        ...
        attrs = self.attrs_fp32 if run_mode != self.TEST_IPU_FP16 else self.attrs_fp16
            ...
            with paddle.static.program_guard(main_prog, startup_prog):
                with paddle.static.amp.fp16_guard():
                    x = paddle.static.data(
                        ...
                        dtype=dtype)
                    x_fill = paddle.full_like(x, **attrs)
...
class TestCase1(TestBase):
    def set_attrs(self):
        self.attrs_fp32 = {'fill_value': 3, 'dtype': 'int32'}
        self.attrs_fp16 = {'fill_value': 3, 'dtype': 'int32'}
