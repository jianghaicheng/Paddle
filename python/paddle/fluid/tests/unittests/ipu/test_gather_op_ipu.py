...
class TestBase(IPUOpTest):
    ...
    def set_feed(self):
        data = np.random.uniform(size=[10, 20])
        self.feed_fp32 = {
    ...
    def set_feed_attr(self):
        ...
        self.feed_fp16dtype = [
            np_dtype_to_fluid_str(x.dtype) for x in self.feed_fp16.values()
        ]
    ...
    def _test_base(self, run_mode=0):
        ...
        dtype = self.feed_fp32dtype if run_mode != self.TEST_IPU_FP16 else self.feed_fp16dtype
